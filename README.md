# Api Rest De Health Check 566F2C

Aplicação backend `api-rest-de-health-check-566f2c` construída com foco em boas práticas de engenharia.

## Visão Geral
- Nome da aplicação: `api-rest-de-health-check-566f2c`
